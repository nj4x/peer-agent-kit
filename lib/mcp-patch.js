...
const [, , configPath, kitDir, codeBin] = process.argv;
if (!configPath || !kitDir) {
  console.error('usage: mcp-patch.js <~/.claude.json> <kit-directory> [code-bin]');
  process.exit(1);
}
...
if (codeBin) newEntry.env = { BRIDGE_CODE_BIN: codeBin };
